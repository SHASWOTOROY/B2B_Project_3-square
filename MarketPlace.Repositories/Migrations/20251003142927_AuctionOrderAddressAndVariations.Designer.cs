...
namespace MarketPlace.Repositories.Migrations
{
    ...
    [Migration("20251003142927_AuctionOrderAddressAndVariations")]
    partial class AuctionOrderAddressAndVariations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketPlace.Models.VariationValue", b =>
                {
                    ...
                    b.HasIndex("VariationTypeId", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("MarketPlace.Models.Auction", b =>
                {
                    ...
                    b.HasOne("MarketPlace.Models.Address", "DeliveryAddress")
                        .WithMany()
                    ...
                    b.OwnsMany("MarketPlace.Models.ProductVariation", "Variations", b1 =>
                        {
                            ...
                            b1.HasKey("AuctionProductId", "TypeId", "ValueId");

                            b1.ToTable("MARKETPLACE_AuctionProductVariation", (string)null);
                    ...
                    b.OwnsMany("MarketPlace.Models.ProductVariation", "Variations", b1 =>
                        {
                            ...
                            b1.HasKey("OrderProductId", "TypeId", "ValueId");

                            b1.ToTable("MARKETPLACE_OrderProductVariation", (string)null);
                    ...
                    b.OwnsMany("MarketPlace.Models.ProductVariationType", "Variations", b1 =>
                        {
                            ...
                            b1.HasKey("ProductId", "TypeId");

                            b1.ToTable("MARKETPLACE_ProductVariationType", (string)null);
                            ...
                            b1.OwnsMany("MarketPlace.Models.ProductVariationValue", "Values", b2 =>
                                {
                                    ...
                                    b2.HasKey("ProductId", "TypeId", "ValueId");

                                    b2.ToTable("MARKETPLACE_ProductVariationValue", (string)null);

                                    b2.WithOwner()
                                        .HasForeignKey("ProductId", "TypeId");
                                });
