...
namespace MarketPlace.Repositories.Migrations
{
    ...
    [Migration("20251002194015_ProductVariationTables")]
    partial class ProductVariationTables
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("MarketPlace.Models.ProductVariationType", "Variations", b1 =>
                        {
                            ...
                            SqlServerPropertyBuilderExtensions.UseIdentityColumn(b1.Property<int>("TypeId"));
                            ...
                            b1.OwnsMany("MarketPlace.Models.ProductVariationValue", "Values", b2 =>
                                {
                                    ...
                                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b2.Property<int>("ValueId"));
